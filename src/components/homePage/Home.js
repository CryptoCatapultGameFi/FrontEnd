      ...
      <div>
        ...
        <div className="instruction-contract"> 
          ...
          <div className="instruction">
            <a className="inst-text" href="https://docs.google.com/document/d/1t1mMhwzs6SwVCHOi5hBrcxaFqhmyaJDaVJVyYfsvO7Y" target="_blank" rel="noopener noreferrer"> Login </a>
            <a className="inst-text" href="https://docs.google.com/document/d/1D35ZMYzVFjFW-JVNY_NTNBlXM1G5taf-sJgMf_-DlmE/edit?usp=sharing" target="_blank" rel="noopener noreferrer"> How to get CCP tokens</a>
          ...
          <div className="contract">
            <a className="inst-text" href="https://docs.google.com/forms/d/e/1FAIpQLSfkdspQi5oq8o-nb8ZgW9bgF76lhEXs_HZyzi4W6iuTJQQ5FA/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer"> 1000 CCP tokens for new user </a>
            <a className="inst-text" href="https://docs.google.com/forms/d/e/1FAIpQLSdUO5hV76zv2Xnkp64cuycN9PkIfocC9u8eo5yVIgOpAln-rQ/viewform" target="_blank" rel="noopener noreferrer"> Provide your feedback </a>
            <a className="inst-text" href="https://docs.google.com/forms/d/e/1FAIpQLSfvFph_OaGe3uJZSf3S_GdnS5qVXCxv1-EdNygV8Tg1kBdV8w/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer"> Report any problem </a>  
          </div>
        </div>
      </div>
    </LayoutPage>
